...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "Jam","No.Reg","Status Bayar","Stts Poli","Kd PJ","Kd Poli","No.Telp Pasien","Lama Tunggu"}){
    ...
    private void aturTampilanDaftarPasien(final JTable table) {
        ...
        final javax.swing.border.Border borderNormal =
        ...
        table.setDefaultRenderer(Object.class, new javax.swing.table.TableCellRenderer() {
            ...
            public java.awt.Component getTableCellRendererComponent(
                    JTable tabel, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                java.awt.Component component = rendererStatus.getTableCellRendererComponent(
                        tabel, value, isSelected, hasFocus, row, column);
                if (isSelected) {
                    ...
                    component.setFont(tabel.getFont().deriveFont(java.awt.Font.PLAIN));
                    if (component instanceof javax.swing.JComponent) {
...
private void MnSudahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSudahActionPerformed
       if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                WaktuPeriksaRalan.catat(TNoRw.getText(),"DlgKasirRalan");
                if(tbKasirRalan.getSelectedRow()>-1){
                    tabModekasir.setValueAt("Sudah",tbKasirRalan.getSelectedRow(),10);
                    tabModekasir.setValueAt(lamaTungguNoRawat(TNoRw.getText()),tbKasirRalan.getSelectedRow(),20);
                }
            }
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    */
            ...
            try{
                ...
                while(rskasir.next()){
                    tabModekasir.addRow(new String[] {
                        ...
                        formatLamaTunggu(rskasir.getString("tgl_registrasi")+" "+rskasir.getString("jam_reg"),rskasir.getString("waktu_selesai"))
                    });
                }                
            } catch(Exception e){
    ...
    private void initKasirRalan() {
        ...
        MnRMRawatJalan.add(MnHasilEndoskopiFaringLaring);
