...
public final class RMResumeMedisRalanV2 extends JDialog {
    ...
    private JLabel labelInfoSoap(String kolomTarget) {
        ...
        if ("keluhan".equals(kolomTarget)) {
            info = "Pilih SOAP dokter. Kolom Subjek akan dimasukkan ke Keluhan Utama.";
        } else if ("pemeriksaan".equals(kolomTarget)) {
            info = "Pilih SOAP dokter. Kolom Objek akan dimasukkan ke Pemeriksaan / Objek.";
        } else if ("rtl".equals(kolomTarget)) {
            info = "Pilih SOAP dokter. Kolom Plan akan dimasukkan ke Plan / Terapi / Obat.";
        }
