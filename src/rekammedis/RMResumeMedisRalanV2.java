...
public final class RMResumeMedisRalanV2 extends JDialog {
    ...
    private JPanel bangunPanelIdentitas() {
        ...
        row = tambahDuaKolom(panel, row, "Tanggal Resume", flowPanel(TTglKeluar, labelKiri("Jam"), TJamKeluar), "Dokter *", flowPanel(TKodeDokter, TNamaDokter, BtnDokter));
        return panel;
    }
    ...
    private void isRawat() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                TRuang.setText(nvl(rs.getString("nm_poli")));
